...
public class XmlFormatTransformerError extends CoteafsError {
	...
	/**
	 * @author wasiq.bhamla
	 * @since Aug 20, 2017 2:19:28 PM
	 * @param message
	 */
	public XmlFormatTransformerError (final String message) {
		super (message);
	}
	 ...
	 * @param cause
	 */
	public XmlFormatTransformerError (final String message, final Throwable cause) {
		super (message, cause);
	}
}